...
const Index = () => {
  ...
  const isLoading = tracksLoading || playlistsLoading || podcastsLoading;
  const hasContent = displayTracks.length > 0 || aiPlaylists.length > 0 || podcasts.length > 0;
              ...
              {!hasContent && (
                <div className="text-center py-12">
                  <div className="text-gray-400 mb-4">
                    ...
                    <h3 className="text-xl font-semibold mb-2">Welcome to MAUDIO</h3>
                    <p className="text-sm">Start exploring music, upload your tracks, or discover new artists</p>
                  </div>
                </div>
              )}
